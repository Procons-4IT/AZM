...
#Region "Filter"
    ...
    Public Sub SetFilter()
        Try
            ...
            'objFilter.AddEx(frm_GRPO)
            'objFilter.AddEx(frm_APCreditnote)
            'objFilter.AddEx(frm_APInvoice)
...
#Region "Menu Event"
    ...
    Private Sub _SBO_Application_FormDataEvent(ByRef BusinessObjectInfo As SAPbouiCOM.BusinessObjectInfo, ByRef BubbleEvent As Boolean) Handles _SBO_Application.FormDataEvent
        Select Case BusinessObjectInfo.FormTypeEx
            Case frm_GRPO, frm_APInvoice, frm_APCreditnote
            ...
            If pVal.BeforeAction = False Then
                Select Case pVal.MenuUID
                    ...
                    Case mnu_BillDiscount
                        oMenuObject = New clsBillDiscounting
                        oMenuObject.MenuEvent(pVal, BubbleEvent)
                    Case mnu_validations
                        oMenuObject = New clsInvoiceValidations
                        oMenuObject.MenuEvent(pVal, BubbleEvent)
                    ...
                    Case mnu_Dismap
                        ...
                        'Case mnu_SalAgeRpt
                        '    oMenuObject = New clsSalesAgingRpt
                        '    oMenuObject.MenuEvent(pVal, BubbleEvent)
        ...
        Try
            ...
            If pVal.EventType = SAPbouiCOM.BoEventTypes.et_FORM_LOAD And pVal.Before_Action = False Then
                Select Case pVal.FormTypeEx
                    Case frm_Validations
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsInvoiceValidations
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
                    Case frm_BillDiscount
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsBillDiscounting
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
                    Case frm_Export
                    ...
                    Case frm_mapping
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsDisMapping
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If

                    Case frm_SpecialPrice
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsDisDefine
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
                    Case frm_Purchasereturn
                        If Not _Collection.ContainsKey(FormUID) Then
                        ...
                        'Case frm_SalesOdrAging
                        '    If Not _Collection.ContainsKey(FormUID) Then
                        '        oItemObject = New clsSalesAgingRpt
                        '        oItemObject.FrmUID = FormUID
                        '        _Collection.Add(FormUID, oItemObject)
                        '    End If
                    ...
                    Case frm_Customermapping
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsCustomerMapping
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
                    Case frm_DiscMapping
                        If Not _Collection.ContainsKey(FormUID) Then
                            oItemObject = New clsDiscMapping
                            oItemObject.FrmUID = FormUID
                            _Collection.Add(FormUID, oItemObject)
                        End If
