...
#Region "AddChooseFromList"
    ...
    Private Sub AddChooseFromList(ByVal aForm As SAPbouiCOM.Form)
        Try
            ...
            oCFLCreationParams.ObjectType = "Z_ODIS"
...
#End Region
    ...
    Public Sub databind(ByVal aCode As String)
        ...
        Try
            ...
            otemprec.DoQuery("Select * from [@Z_Dis_Mapping] where U_Z_CardCode='" & aCode & "'")
            If otemprec.RecordCount > 0 Then
                oApplication.Utilities.LoadForm(xml_DiscMapping, frm_DiscMapping)
                oForm = oApplication.SBO_Application.Forms.ActiveForm()
                '  oForm.EnableMenu(mnu_ADD_ROW, True)
                ' oForm.EnableMenu(mnu_DELETE_ROW, True)
                AddChooseFromList(oForm)
                If oForm.TypeEx = frm_DiscMapping Then
                    oForm.Freeze(True)
                    oApplication.Utilities.SetEditText(oForm, "4", aCode)
                    oApplication.Utilities.SetEditText(oForm, "7", otemprec.Fields.Item("U_Z_CardName").Value)
                    oGrid = oForm.Items.Item("8").Specific
                    oGrid.DataTable.ExecuteQuery("Select Code,U_Z_Dis_Code,U_Z_Dis_Name,U_Z_FromDate,U_Z_Todate from [@Z_Dis_Mapping] where U_Z_CardCode='" & aCode & "'")
                    FormatGrid(oGrid)
                    oForm.Freeze(False)
                End If
    ...
    Private Sub FormatGrid(ByVal aGrid As SAPbouiCOM.Grid)
        ...
        aGrid.Columns.Item(1).TitleObject.Caption = "Discount Code"
        oEditTextColumn = aGrid.Columns.Item(1)
        oEditTextColumn.ChooseFromListUID = "CFL2"
        oEditTextColumn.ChooseFromListAlias = "U_Z_Dis_Code"
        oEditTextColumn.LinkedObjectType = "Z_ODIS"
        aGrid.Columns.Item(2).TitleObject.Caption = "Discount Name"
...
#Region "AddtoUDT"
    Private Function AddtoUDT1(ByVal aform As SAPbouiCOM.Form) As Boolean
        ...
        strCardName = oApplication.Utilities.getEdittextvalue(aform, "7")
        ...
        For intRow As Integer = 0 To oGrid.DataTable.Rows.Count - 1
            ...
            If strCode = "" Then
                ...
                strDiscode = oGrid.DataTable.GetValue(1, intRow)
                strDisname = oGrid.DataTable.GetValue(2, intRow)
...
#Region "Item Event"
    Public Overrides Sub ItemEvent(ByVal FormUID As String, ByRef pVal As SAPbouiCOM.ItemEvent, ByRef BubbleEvent As Boolean)
        Try
            If pVal.FormTypeEx = frm_DiscMapping Then
                            ...
                            Case SAPbouiCOM.BoEventTypes.et_CHOOSE_FROM_LIST
                                ...
                                Try
                                    ...
                                    If (oCFLEvento.BeforeAction = False) Then
                                        ...
                                        oForm.Freeze(True)
                                        oForm.Update()
                                        If pVal.ItemUID = "8" And pVal.ColUID = "U_Z_Dis_Code" Then
