        ...
        Try
            ...
            For intRow As Integer = 0 To oRecBP.RecordCount - 1
                ...
                If oRecTemp.RecordCount > 0 Then
                    ...
                    strsql = "Select TransId, RefDate, DueDate, TaxDate, TransType, BaseRef, Ref1, Ref2, Ref3Line, LineMemo, ContraAct, AcctName,"
                    strsql = strsql & "  isnull(Debit,0) 'Debit', isnull(Credit,0) 'Credit', JDT1.Project, OPRJ.PrjName, ShortName, isnull(FCDebit,0) 'FCDebit', isnull(FCCredit,0) 'FCCredit', isnull(SYSDeb,0) 'SystDebit', isnull(SYSCred,0) 'SysCredit', FCCurrency,isnull(U_SMNo,'') 'SMNO' , isnull(jdt1.U_Cardcode,'') 'Branch' ,isnull(JDT1.TransCode,'') 'TranCode'"
                    ...
                    If intReportChoice = 2 Then
                        ...
                        stPDCQuery = "select DueDate,DocNum,CheckNum,CheckSum from RCT1 where duedate > '" & dtAgingdate.ToString("yyy-MM-dd") & "' and  DocNum in (Select Docentry from ORCT where  canceled='N' and CardCode='" & strBP.Replace("'", "''") & "' ) order by DueDate,DocNum"
